...
static const char *fieldsOfStudyName[] = {"Computer Science", "Mathematics",
...
void MY_STUDENT_Print(void *ptr) {
  ...
  if (p) {
    printf_s(custom_messages[MESSAGE__STUDENT_PRINT], p->student_surname,
             p->birth_year, fieldsOfStudyName[p->field_of_study],
             p->field_of_study);
  }
}
